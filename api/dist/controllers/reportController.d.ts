...
export declare const addAerosolUnit: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const updateAerosolUnit: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const deleteAerosolUnit: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
