 ...
 * @version 2.0.0 - Using html-pdf-node (Puppeteer wrapper, no installation needed)
 */
...
export class PDFService {
  ...
  async generateReportPDF(reportId: number): Promise<string> {
    ...
    try {
      ...
      logger.info('Converting HTML to PDF', { reportId });
      ...
      logger.info('PDF file created', { reportId, filePath });
      ...
      try {
        ...
        logger.error('PDF file verification failed', { reportId, filePath, error });
