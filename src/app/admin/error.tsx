      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-8">
            An error occurred in the admin section. This could be due to permissions or a temporary issue.
          </p>
        </div>
        ...
        <p className="mt-8 text-sm text-gray-500">
          If this problem persists, please check your permissions or contact technical support.
        </p>
      </div>
    </div>
  );
